...
const SERVER_DESCRIPTION = "Basis Protocol CQI — composition: CQI pair lookups, portfolio/collateral stress, reports (Basel SCO60, MiCA, GENIUS), RQS, contagion traversal.";
await runServer({
